...
Download the latest setup file [here](https://github.com/Tamer-ElSayed/SMRF/releases/download/v2.1/SMRF.2.1.Setup.exe) and run it. Or to view the source code of this program on github click [here](https://github.com/Tamer-ElSayed/SMRF).
